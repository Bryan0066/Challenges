...
You are tasked with building a game of Rock, Paper, Scissors.
Write a program where the user can play one round of **Rock, Paper, Scissors** against the computer. The game will be played in the terminal.
