...
`The first transaction is: 50000`
* What is the value of the second transaction?
`The second transaction is: -2000`
* What is the value of the fourth transaction?
`The fourth transaction is: 4000`
* What is the value of the last transaction?
`The last transaction is: 42000`
* What is the value of the second from last transaction?
`The second from the last transaction is: -50000`
* What is the value of the 5th from last transaction?
`The fifth from the last transaction is: -30000`
* What is the value of the transaction with index 5?
`The transaction with the index of 5 is: 5000`
* How many transactions are there in total?
`The total number of transactions is: 14`
* How many positive transactions are there in total?
`The total number of positive transactions is: 7`
* How many negative transactions are there in total?
`The total number of negative transactions is: 7`
* What is the largest withdrawal?
`The largest withdrawal is: -50000`
* What is the largest deposit?
`The largest deposit is: 62000`
* What is the smallest withdrawal?
`The smallest withdrawal is: -800`
* What is the smallest deposit?
`The smallest deposit is: 4000`
* What is the net balance of all the transactions?
`The total value of all the transactions is: 100300`
